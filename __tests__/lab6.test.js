describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    let shadow_root = await (await prodItem.getProperty('shadowRoot')).asElement();
    let shadow_button = await shadow_root.$('button');
    await shadow_button.click(); 
    let inner = await shadow_button.getProperty('innerText');
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    let cartCount = await page.$eval('#cart-count', cart => cart.innerText);
